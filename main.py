...
bajo la dirección de la <b>Dra. Xóchitl Rosío Angélica Trujillo Trujillo</b>. Este trabajo demuestra cómo la <b>colaboración interdisciplinaria</b> facilita el análisis de casos en los que técnicas avanzadas de procesamiento y análisis de datos se aplican en contextos novedosos, promoviendo la transferencia de conocimiento entre distintas áreas de la ciencia. Esta estancia fue posible gracias a la colaboración entre la 
